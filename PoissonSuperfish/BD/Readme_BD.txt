...
Borland Delphi main program that calls a DLL generated with 
LF95, we will include them in this directory.
...
fld_bd.dll       Dynamic link library
fld_bd.obj       Object module used to create the DLL
fld_bd.lib       Microsoft-compatible import library  



If you develop an example Borland Delphi main program file that 
performs the same task as the LF95 programs Sample.F90 and 
...
file, extract the following additional files to the BD subdirectory:

fld1_BD.dll, fld2_BD.dll, fld3_BD.dll   Dynamic link libraries
fld1_BD.obj, fld2_BD.obj, fld3_BD.obj   Object modules 
fld1_BD.lib, fld2_BD.lib, fld3_BD.lib   Import libraries  

Each DLL contains the same the four functions as fld_BD.dll, but the 
functions have the number 1, 2, or 3 appended to their names.  For
example, file fld1_BD.dll contains functions INTERP1, I_Variable1,
...
dumpbin /exports fld_bd.dll

Microsoft (R) COFF Binary File Dumper Version 6.00.8447
Copyright (C) Microsoft Corp 1992-1998. All rights reserved.


Dump of file fld_bd.dll

File Type: DLL

  Section contains the following exports for fld_bd.dll

           0 characteristics
    40E423AA time date stamp Thu Jul 01 08:46:02 2004
        0.00 version
           1 ordinal base
