Echo off
cls
Echo This batch file demonstrates building a LF90 main program that
Echo uses the interpolator in dynamic link library Fld_LF90.DLL.
Echo This file will work as distributed only if the Lahey Fortran 
Echo compiler LF90 plus the Winteracter 4.0 development tools are 
...
Echo Linking with the dynamic link library Fld_LF90.DLL.

lf90 sample_dll.f90 -nfix  Fld_LF90.imp  
pause
